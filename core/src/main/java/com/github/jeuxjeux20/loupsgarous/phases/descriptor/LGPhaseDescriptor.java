...
public final class LGPhaseDescriptor extends Descriptor<LGPhase> {
    ...
    public LGPhaseDescriptor(Class<? extends LGPhase> describedClass) {
    ...
    /**
     * Gets the title of the phase, which is shown in the chat and as a subtitle
    ...
    /**
     * Sets the title of the phase, which is shown in the chat and as a subtitle
     * when the phase starts.
     * <p>
     * If the returned string is {@code null}, no title will be shown.
     *
    ...
    /**
     * Gets the color of this phase, which is used as the
    ...
    /**
     * Sets the color of this phase, which is used as the
     * boss bar color and other various places.
     *
     * @param color the phase color, a value of {@code null}
     *              sets a {@link PhaseColor#DEFAULT} value instead
     */
    ...
    /**
     * Determines whether or not this phase should be deleted
